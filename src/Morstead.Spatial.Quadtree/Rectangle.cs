...
namespace Morstead.Spatial.Quadtree
{
    ...
    [TypeConverter("Morstead.Spatial.Quadtree.RectangleConverter, System.Drawing, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")]
    public struct Rectangle : IEquatable<Rectangle>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref='Morstead.Spatial.Quadtree.Rectangle'/> class with the specified location
        /// and size.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new <see cref='Morstead.Spatial.Quadtree.Rectangle'/> with the specified location and size.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the size of this <see cref='Morstead.Spatial.Quadtree.Rectangle'/>.
        /// </summary>
        [Browsable(false)]
        public Size Size
        {
        ...
        /// <summary>
        /// Gets or sets the width of the rectangular region defined by this <see cref='Morstead.Spatial.Quadtree.Rectangle'/>.
        /// </summary>
        public int Width
        {
            readonly get => width;
        ...
        /// <summary>
        /// Tests whether this <see cref='Morstead.Spatial.Quadtree.Rectangle'/> has a <see cref='Morstead.Spatial.Quadtree.Rectangle.Width'/>
        /// or a <see cref='Morstead.Spatial.Quadtree.Rectangle.Height'/> of 0.
        /// </summary>
        [Browsable(false)]
        public readonly bool IsEmpty => height == 0 && width == 0 && x == 0 && y == 0;

        /// <summary>
        /// Tests whether <paramref name="obj"/> is a <see cref='Morstead.Spatial.Quadtree.Rectangle'/> with the same location
        ...
        /// <summary>
        /// Tests whether two <see cref='Morstead.Spatial.Quadtree.Rectangle'/> objects have equal location and size.
        /// </summary>
        public static bool operator ==(Rectangle left, Rectangle right) =>
            left.X == right.X && left.Y == right.Y && left.Width == right.Width && left.Height == right.Height;

        /// <summary>
        /// Tests whether two <see cref='Morstead.Spatial.Quadtree.Rectangle'/> objects differ in location or size.
        /// </summary>
        ...
        /// rectangular region represented by this <see cref='Morstead.Spatial.Quadtree.Rectangle'/> .
        /// </summary>
        ...
        /// <summary>
        /// Converts the attributes of this <see cref='Morstead.Spatial.Quadtree.Rectangle'/> to a human readable string.
        /// </summary>
