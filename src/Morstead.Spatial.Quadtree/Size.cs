...
namespace Morstead.Spatial.Quadtree
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref='Morstead.Spatial.Quadtree.Size'/> class.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref='Morstead.Spatial.Quadtree.Size'/> class from the specified
        /// <see cref='Morstead.Spatial.Quadtree.Point'/>.
        /// </summary>
        public Size(Morstead.Spatial.Quadtree.Point pt)
        {
            width = pt.X;
            height = pt.Y;
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref='Morstead.Spatial.Quadtree.Size'/> class from the specified dimensions.
        /// </summary>
        ...
        /// <summary>
        /// Converts the specified <see cref='Morstead.Spatial.Quadtree.Size'/> to a <see cref='Morstead.Spatial.Quadtree.SizeF'/>.
        /// </summary>
        public static implicit operator SizeF(Size p) => new SizeF(p.Width, p.Height);

        /// <summary>
        /// Performs vector addition of two <see cref='Morstead.Spatial.Quadtree.Size'/> objects.
        /// </summary>
        public static Size operator +(Size sz1, Size sz2) => Add(sz1, sz2);

        /// <summary>
        /// Contracts a <see cref='Morstead.Spatial.Quadtree.Size'/> by another <see cref='Morstead.Spatial.Quadtree.Size'/>
        /// </summary>
        ...
        /// <summary>
        /// Tests whether two <see cref='Morstead.Spatial.Quadtree.Size'/> objects are identical.
        /// </summary>
        public static bool operator ==(Size sz1, Size sz2) => sz1.Width == sz2.Width && sz1.Height == sz2.Height;

        /// <summary>
        /// Tests whether two <see cref='Morstead.Spatial.Quadtree.Size'/> objects are different.
        /// </summary>
        public static bool operator !=(Size sz1, Size sz2) => !(sz1 == sz2);

        /// <summary>
        /// Converts the specified <see cref='Morstead.Spatial.Quadtree.Size'/> to a <see cref='Morstead.Spatial.Quadtree.Point'/>.
        /// </summary>
        public static explicit operator Point(Size size) => new Point(size.Width, size.Height);

        /// <summary>
        /// Tests whether this <see cref='Morstead.Spatial.Quadtree.Size'/> has zero width and height.
        /// </summary>
        [Browsable(false)]
        public readonly bool IsEmpty => width == 0 && height == 0;

        /// <summary>
        /// Represents the horizontal component of this <see cref='Morstead.Spatial.Quadtree.Size'/>.
        /// </summary>
        public int Width
        {
            readonly get => width;
        ...
        /// <summary>
        /// Represents the vertical component of this <see cref='Morstead.Spatial.Quadtree.Size'/>.
        /// </summary>
        public int Height
        {
            readonly get => height;
        ...
        /// <summary>
        /// Tests to see whether the specified object is a <see cref='Morstead.Spatial.Quadtree.Size'/>  with the same dimensions
        /// as this <see cref='Morstead.Spatial.Quadtree.Size'/>.
        /// </summary>
        ...
        /// <summary>
        /// Creates a human-readable string that represents this <see cref='Morstead.Spatial.Quadtree.Size'/>.
        /// </summary>
